    ...
    >
      ...
      {images.map((img, index) => (
        <motion.img
          ...
          className={
            animationStyle === "dynamic"
              ? "pointer-events-none absolute h48 h-[8em] w-[8em] rounded-full border border-black/30 bg-white/70 dark:border-white/20 dark:bg-neutral-900 opacity-0 shadow-md transition-all duration-300"
              : "pointer-events-none absolute h48 h-[8em] w-[8em] rounded-full border border-black bg-neutral-100 opacity-0 dark:border-neutral-800 dark:bg-neutral-900 backdrop-blur-md saturate-150"
          }
          initial={false}
        />
      ))}
