...
function ImageEffect({color={secondaryColor},height='100%',width='100%',type='x',img='/images/service01.png',className='',from='left',to='right'}) {
  ...
  return (
    <div ref={mergeRefs(ref,scope)} className='[width:max-content relative'>
      ...
      <img style={{height,width}} className={`${className} relative image opacity-0 h-auto object-cover`} src={img} />
        <div style={{height,width}} className='overlay will-change-transform scale-0 bg-brand-black  absolute top-0 left-0'>
