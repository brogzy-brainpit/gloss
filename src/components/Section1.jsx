...
function Section1({preLoaderOut}) {
  ...
  return (
    <div className='flex justify-between h-svh pt-9 bg-black'>
          <Section>
         <div className=' text-[clamp(2.4em,_4vw_+_0.5em,_4em)] text-brand-white text-center leading-[1.1] font-custom max-w-[23em] mx-auto my-4 relative w-[75%] h-full overflow-hidden'>
