       ...
       <GridColumn className='bg-brand-secondary py-10 px-[.625rem] h-full rounded-3xl '>
        <div className="col-span-6">
         ...
         <div className="col-span-3 flex gap-2 flex-col">
          ...
          <Copy colorBlock={accentColor} text={'About'} trigger={true}/>
          </Link>
          <Link href={'/'} className='font-body text-para capitalize text-brand-black'><Copy colorBlock={accentColor} text={'Projects'} trigger={true}/></Link>
          <Link href={'/'} className='font-body text-para capitalize text-brand-black'> <Copy colorBlock={accentColor} text={'Gallery'} trigger={true}/></Link>
          <Link href={'/'} className='font-body text-para capitalize text-brand-black'> <Copy colorBlock={accentColor} text={'Contact'} trigger={true}/></Link>
        </div>
          <div className="col-span-3 flex gap-2 flex-col">
          <h2 className='font-body w-fit text-para uppercase text-brand-black font-bold mb-2 py-[5px]'> <Copy colorBlock={accentColor} text={'Company'} trigger={true}/></h2>
          <Link href={'/'} className='font-body text-para capitalize text-brand-black'>
        ...
        <div className="col-span-3 py-6 flex  flex-col lg:justify-end b-red-600">
          <h2 className='font-body w-fit text-para uppercase bg-brand-black text-brand-secondary px-[5px]'>visit us</h2>
        ...
        <div className="col-span-3 py-6 flex flex-col lg:justify-end">
          ...
          <h2 className='font-body text-para uppercase text-brand-black p-2'><sup>&copy;</sup> Gloss autos</h2>
        </div>
